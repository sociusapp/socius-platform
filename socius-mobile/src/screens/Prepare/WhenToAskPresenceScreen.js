...
const WhenToAskPresenceScreen = ({ navigation }) => {
  const { contentWidth, ms, spacing, vscale, scale } = useResponsive();

  return (
    <SafeAreaView style={styles.container}>
      <Header 
        title="When to Ask Presence" 
      ...
      >
        <View style={{ width: contentWidth, alignItems: 'center' }}>
          <Text style={[styles.title, { fontSize: ms(22), marginBottom: vscale(12) }]}>When to Ask Presence</Text>
