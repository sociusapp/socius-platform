...
const WhatsHappeningScreen = ({ navigation }) => {
  ...
  const colors = useMemo(
    () => ({
      ...
      cardBorder: isDark ? '#334155' : '#F1F2F4',
      textPrimary: isDark ? '#E5E7EB' : '#2C3E50',
      textSecondary: isDark ? '#9CA3AF' : '#666666',
      searchBg: isDark ? '#111827' : '#F3F4F6',
      searchText: isDark ? '#E2E8F0' : '#111827',
      divider: isDark ? '#273449' : '#E8EAED',
      iconMuted: isDark ? '#94A3B8' : '#999999',
    }),
    [isDark]
  );
