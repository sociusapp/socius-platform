...
const ViewDetailsIgnoreScreen = ({ navigation }) => {
  const { contentWidth, ms, spacing, vscale, scale } = useResponsive();

  return (
    <SafeAreaView style={styles.container}>
      <Header 
        title="View Details Ignore" 
      ...
      >
        <View style={{ width: contentWidth, alignItems: 'center' }}>
          <Text style={[styles.title, { fontSize: ms(22), marginBottom: vscale(12) }]}>View Details Ignore</Text>
