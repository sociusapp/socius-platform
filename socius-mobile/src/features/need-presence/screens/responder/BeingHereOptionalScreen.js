...
const BeingHereOptionalScreen = ({ navigation }) => {
  const { contentWidth, ms, spacing, vscale, scale } = useResponsive();

  return (
    <SafeAreaView style={styles.container}>
      <Header 
        title="Being Here Optional" 
      ...
      >
        <View style={{ width: contentWidth, alignItems: 'center' }}>
          <Text style={[styles.title, { fontSize: ms(22), marginBottom: vscale(12) }]}>Being Here Optional</Text>
...
export default BeingHereOptionalScreen;
