...
import { View, Text, StyleSheet, ScrollView, Image, TouchableOpacity, Animated, useWindowDimensions, RefreshControl, FlatList, TextInput, Platform, ActivityIndicator } from 'react-native';
...
import DailyHelpRequestCard from '../../components/cards/DailyHelpRequestCard';
import DailyHelpHistoryCard from '../../components/cards/DailyHelpHistoryCard';
...
const CommunityScreen = ({ navigation }) => {
  ...
  /** App is light-mode only; do not branch on system dark mode */
  ...
  }, [isFocused, activeTab, fetchNearbyRequests, fetchHistory, fetchBlogTypes, fetchSurvey]);
  ...
  const onRefresh = useCallback(async () => {
    ...
    setRefreshing(false);
  }, [activeTab, fetchNearbyRequests, fetchHistory, fetchBlogTypes, fetchSurvey]);
      ...
      >
        <View style={{ width: contentWidth }}>
          ...
          >
            ...
            <View style={[styles.helpCardTabsRow, { backgroundColor: '#F3F4F6' }]}>
              <TouchableOpacity
                activeOpacity={0.85}
                ...
                style={[
                  ...
                  helpCardTab === 'request' && [
                    ...
                    { backgroundColor: colors.cardBg, shadowOpacity: 0.08 },
                  ],
                ]}
              >
                <Icon
                                ...
                                <TouchableOpacity
                                  ...
                                  style={[
                                    styles.surveyVoteBtn,
                                    {
                                      ...
                                      backgroundColor: liked ? '#FDF2F2' : colors.pointsBg,
                                    },
                                  ]}
                                >
                                  <Icon
                                ...
                                <TouchableOpacity
                                  ...
                                  style={[
                                    styles.surveyVoteBtn,
                                    {
                                      ...
                                      backgroundColor: disliked ? '#F1F5F9' : colors.pointsBg,
                                    },
                                  ]}
                                >
                                  <Icon
